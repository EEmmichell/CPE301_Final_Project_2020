...
//Allow as user to enable or disable the system using an on/off button
//Record the time and date every time the motor is turned on or off. This information should 
